...
def create_mcp_server() -> FastMCP:
    ...
    from .auth import create_auth, ensure_api_key
    ...
    # Ensure API key exists (auto-generates and saves to .env if needed)
    api_key = ensure_api_key()
    auth = create_auth(api_key=api_key, base_url=base_url)
